"""
Django settings for clony project.
...
SECRET_KEY = 'django-insecure-#yq!s5ze685mat0sdp^%xip8vg&9)p3kp=c+q-$$gpt$gbek+*'
...
WSGI_APPLICATION = 'clony.wsgi.application'
